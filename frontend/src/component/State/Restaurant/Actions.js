...
export const getRestaurantById = (reqData) =>{
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type: GET_RESTAURANT_BY_ID_FAILURE, paylaod: error});
        }
    }
}
    ...
    return async (dispatch) =>{
        ...
        try{
            const res = await api.put(
                `/api/admin/restaurants/${restaurantId}`,restaurantData,{
                headers:{
                    Authorization: `Bearer ${jwt}`,
                },
            });
...
export const updateRestaurantStatus = ({restaurantId,jwt})=>{
    console.log("jwt",jwt)
    return async (dispatch) =>{
        console.log("ressss ",restaurantId)
